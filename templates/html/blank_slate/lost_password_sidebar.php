<form onsubmit="return processLostPass();" id="lostpass_form">
	...
	<div style="float:left;">
		<p class="small"><a href="#" onclick="showLogin();return false;">Login</a> | <a href="#" onclick="showRegister();return false;">Register</a></a></p>
	</div>
	<div class="clear"></div>

...
<div id="bd_aie_editor">
	...
	<div id="bd_edit_right">
		...
		<ul id="bd_right_save">
			...
			<li><center><a href="#" onclick="saveArticle('1');return false;"><img src="%program_url%/templates/html/_imgs/editor/icon-done.png" width="20" height="20" border="0" alt="Save and finalize edits" title="Save and finalize edits" /></a></center></li>

				...
				<div class="bd_com_overall" id="bd_com_overall%comment_id%" %com_style%>
					<div class="bd_comment %add_class%" id="comment%comment_id%">
						...
						<div class="bd_comment_right">				
							<div class="bd_comment_top">
								<span class="bd_comment_date">Posted on %comment_date%</span>
								<span class="bd_comment_user">by %comment_username%</span>
							</div>
							<div class="bd_comment_main" id="commentMain%comment_id%">
								%comment%
							</div>
							...
							<div class="bd_comment_options" id="showReplyTop%comment_id%">
								%comment_options%
							</div>
						</div>
					 	<div class="bd_clear"></div>

...
%meta_menu%
	<div id="bd_aie_top">
		<ul id="bd_aie_top_left">
			<li class="name"><input type="text" name="name" class="article_name" value="%article_name%" tabindex="1" style="width:250px;" /></li>
		...
		<ul id="bd_aie_top_right">
			<li><a href="#" onclick="minimizeEdit('%article_name%');return false;"><img src="%theme%/imgs/icon-minimize.png" width="16" height="16" border="0" alt="Minimize editor" title="Minimize Editor" style="vertical-align:middle;" /></a></li>
			<li><input type="button" id="bd_air_done_button" value="Done Editing" onclick="saveArticle('1');" /></li>
	...
	<div id="bd_aie_body">
		...
		<div id="bd_aie_container">
			<textarea name="article_content" cols="1" rows="1" id="content" onkeyup="triggerEdit();" onchange="triggerEdit();">%article_content%</textarea>
		</div>
	</div>
